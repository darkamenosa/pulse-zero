...
Gem::Specification.new do |spec|
  ...
  spec.description = "Generate a complete real-time broadcasting system for Rails applications using Inertia.js with React. All code is generated into your project with zero runtime dependencies."
